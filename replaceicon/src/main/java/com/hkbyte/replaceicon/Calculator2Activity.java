...
import com.hkbyte.replaceicon.databinding.ActivityCalculator2Binding;
...
@Route(ReplaceRouter.CALCULATOR_2_ACTIVITY)
public class Calculator2Activity extends BaseActivity<ActivityCalculator2Binding, BaseViewModel> {
    ...
    public int getLayout() {
        return R.layout.activity_calculator_2;
    }
}
